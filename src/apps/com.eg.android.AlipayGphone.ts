...
export default defineAppConfig({
  ...
  groups: [
    ...
    },
    {
      key: 12,
      name: '全屏广告-2023资产报告',
      activityIds: 'com.alipay.mobile.nebulax.integration.mpaas.activity.NebulaActivity',
    ...
    },
    {
      ...
      activityIds: 'com.alipay.mobile.nebulax.xriver.activity.XRiverActivity',
      rules: '[id="com.alipay.mobile.nebula:id/h5_pc_container"] >n View[childCount=1] > View[childCount=2] > View + Image',
