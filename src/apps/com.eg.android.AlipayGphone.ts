  ...
  groups: [
    {
      ...
      rules: [
        ...
        },
        {
          ...
          snapshotUrls: [
            'https://gkd-kit.songe.li/import/12826077', // com.alipay.android.msp.ui.views.MspUniRenderActivity
            'https://gkd-kit.songe.li/import/12846198', // com.alipay.android.msp.ui.views.MspContainerActivity
          ],
        },
      ],
    },
