    ...
    "groups":[
        {
            ...
            "rules":[
                {
                    "activityIds":[
                        "com.miui.video.feature.main.MainTabActivity"
                    ],
                    "matches":[
                        "Button[id=\"com.miui.video:id/close_btn\"]"
                    ],
                    "snapshotUrls":[
                        "https://i.gkd.li/import/13554496"
                    ],
                    "exampleUrls":[
            ...
            "rules":[
                {
                    ...
                    "matches":[
                        "ImageView[id=\"com.miui.video:id/v_icon\"]"
                    ],
                    "snapshotUrls":[
                        "https://i.gkd.li/import/13554375"
                    ],
                    "exampleUrls":[
