...
export default defineAppConfig({
  ...
  groups: [
    ...
    },
    {
      ...
      rules:
        'ViewGroup > ViewGroup +(5) ViewGroup > ImageView',
    ...
    },
    {
      ...
      activityIds: 'com.meituan.retail.c.android.mrn.mrn.MallMrnModal',
      rules:
        '[text="小调查"] + ViewGroup > ViewGroup > ImageView',
    ...
    },
    {
      ...
      rules:
        'FrameLayout > @ImageView + ImageView[desc="资质与规则"]',
      snapshotUrls: 'https://gkd-kit.gitee.io/import/12639734',
    },
  ],
});
